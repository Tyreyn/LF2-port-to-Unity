// <copyright file="Skill4.cs" company="GG-GrubsGaming">
...
namespace Assets.Scripts.StateMachine.State
{
    ...
    /// </summary>
    public class MultipleShot : TemplateState
    {
        #region Constructors and Destructors

        /// <summary>
        /// Initializes a new instance of the <see cref="MultipleShot"/> class.
        /// </summary>
        /// <param name="player">
        ...
        /// </param>
        public MultipleShot(GameObject player, StateMachineClass stateMachine)
