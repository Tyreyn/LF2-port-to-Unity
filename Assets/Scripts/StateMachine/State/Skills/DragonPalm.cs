// <copyright file="Skill2.cs" company="GG-GrubsGaming">
...
namespace Assets.Scripts.StateMachine.State
{
    ...
    /// </summary>
    public class DragonPalm : TemplateState
    {
        #region Constructors and Destructors

        /// <summary>
        /// Initializes a new instance of the <see cref="DragonPalm"/> class.
        /// </summary>
        /// <param name="player">
        ...
        /// </param>
        public DragonPalm(GameObject player, StateMachineClass stateMachine)
